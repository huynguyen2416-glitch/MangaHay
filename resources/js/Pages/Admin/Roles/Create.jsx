        ...
        <AdminLayout>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Tên Vai trò (Role Name) <span className="text-red-500">*</span></label>
                        <input 
                            type="text" 
                            ...
                            placeholder="VD: Staff, Uploader, Editor..."
                        />
                    ...
                    <div className="pt-4 flex justify-end">
                        <button 
                            type="submit" 
                            disabled={processing}
                            className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg font-medium transition flex items-center gap-2 disabled:opacity-70"
                        >
                            <i className="fas fa-save"></i> {processing ? 'Đang lưu...' : 'Lưu Vai trò'}
                        </button>
                    </div>
                </form>
            </div>
